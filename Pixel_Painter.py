...
class PixelApp:
    ...
    def __init__(self,root):
        ...
        newproject_button = Button(control_frame, text="New", command=self.press_new_button)
        newproject_button.grid(column=0, row=0, columnspan=2, sticky=(N, E, S, W), padx=5, pady=5)

        savebutton_button = Button(control_frame, text="Save", command=self.press_save_button)
        savebutton_button.grid(column=2, row=0, columnspan=2, sticky=(N, E, S, W), padx=5, pady=5)
        ...
        self.selected_colour_box = Frame(control_frame, borderwidth=3, relief="raised", bg="white")
        self.selected_colour_box.grid(column=15, row=0, sticky=(N, E, S, W), padx=4, pady=4)
